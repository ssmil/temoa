...
#    Removed inter-day ramp constraints as they don't make sense for non-contiguous days
...
#    )
#
#    Removed inter-period ramp constraints given representative day version
